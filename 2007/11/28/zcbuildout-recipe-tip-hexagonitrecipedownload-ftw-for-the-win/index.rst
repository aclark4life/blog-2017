...
Fortunately there is ``hexagonit.recipe.download``, which allows you to specify the destination. For example, **ZNagios** (an add-on that integrates Zope with Nagios) is available as a tarball here:
