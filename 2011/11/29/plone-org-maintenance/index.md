...
**I am planning to do some work on the plone.org server and website by
the end of the year.**
...
Switch from xdv to
[plone.app.theming](http://pythonpackages.com/info/plone.app.theming)

-   Reduce the number of NGINXes running on the server by 1 (we
    currently have an nginx doing the xdv transform)
...
Prune tickets on [dev.plone.org](http://dev.plone.org/)

I\'ve done some of this work already, earlier this year:

-   <https://github.com/plone/Products.PloneOrg/commits/4.1-compat>
